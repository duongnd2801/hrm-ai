          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 dark:text-white/20 hover:text-indigo-600 dark:hover:text-white transition-colors p-2"
              >
                {showPass ? (
